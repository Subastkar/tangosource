...
~~~sh
# getting the code
git clone git@github.com:nko4/tangosource.git && cd ./tangosource/

# developing
npm install
npm start

# deploying (to http://tangosource.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@tangosource.2013.nodeknockout.com
ssh root@tangosource.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@tangosource.2013.nodeknockout.com
ssh -i ./id_deploy root@tangosource.2013.nodeknockout.com
~~~
